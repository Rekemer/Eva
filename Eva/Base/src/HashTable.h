...
namespace cereal {
	...
	void save(Archive& archive, const Eva::HashTable& func);
	template <class Archive>
	void load(Archive& archive, Eva::HashTable& func);
}
...
namespace Eva
{
	...
	private:
		...
		template <class Archive>
		friend void ::cereal::load(Archive & archive, Eva::HashTable & v);
		template <class Archive>
		friend void ::cereal::save(Archive& archive, const  Eva::HashTable& v);
		// entries + tombstones
